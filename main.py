...
from utils import process_rgb_image, retrive_data, process_depth_image, process_sem_seg_image, process_point_cloud, add_open3d_axis, is_empty
...
def main():
    try:
        ...
        empty_points = empty_line_set.points
        ...
        while True:
            ...
            if len(line_sets) != 0:    
                for i, box in enumerate(bounding_boxes):
                    if is_empty(point_list, box, threshold=cfg['vehicle_detection_threshold']):
                        line_sets[i].points = empty_points
