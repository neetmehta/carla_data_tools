    ...
    def sensor_setup(self, world):
        ...
        for sensor in sensors:
            ...
            if sensor['sensor_type'] == 'lidar':
                ...
                lidar_bp.set_attribute('points_per_second',str(sensor['points_per_second']))
                lidar_bp.set_attribute('rotation_frequency',str(sensor['rotation_frequency']))
                ...
                lidar_bp.set_attribute('dropoff_general_rate',str(sensor['dropoff_general_rate']))
                lidar_bp.set_attribute('dropoff_intensity_limit',str(sensor['dropoff_intensity_limit']))
                lidar_bp.set_attribute('dropoff_zero_intensity',str(sensor['dropoff_zero_intensity']))
